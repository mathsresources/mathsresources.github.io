...
Start by *expanding* $k\sin{(x+a)\degree}$, using the formula sheet to help, and hence find the values of $k\sin{a}\degree$ and $k\cos{a\degree}$.
...
For part (b), use your answer for part (a). What is the maximum value on the graph of $y=\sin{x}\degre$, and for what value of $x$ does it occur? If you can work out the answer to that, think about how the graph of $y=\sin{x\degree} has been *transformed*.
